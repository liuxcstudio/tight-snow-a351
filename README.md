...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tight-snow-a351)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tight-snow-a351
```

A live public deployment of this template is available at [https://tight-snow-a351.templates.workers.dev](https://tight-snow-a351.templates.workers.dev)
